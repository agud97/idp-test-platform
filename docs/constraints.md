...
**MUST** define the Environment as a Kubernetes Custom Resource backed by a CRD. The CRD **MUST** have:
...
2. Asserts the generated `environment.yaml` is a valid Environment CRD
